...
create table RESEARCH_PROJECT (Research_Porject_ID integer not null, type varchar(255), projectType varchar(255), projectName varchar(255), supportUnit varchar(255), projectLevel varchar(255), charger varchar(255), assistant varchar(255), projectFunding double precision, delegatedDepartment varchar(255), primary key (Research_Porject_ID)) engine=InnoDB;
